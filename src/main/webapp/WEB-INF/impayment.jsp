...
<html>
<head>
	<title>Step 5 - Заявка оформлена</title>
...
<a name="imGoToCont"></a>
	<div id="imContent">
<h2>Step 5 - Заявка оформлена</h2>
<div id="imCartText">Ваша заявка успешно отправлена и будет обработана в ближайшее время.<br /><br />Вам будет послано письмо со всеми введенными вами данными, а так же инструкции по доставке и оплате.<br /><br />Для того, чтобы отслеживать ваш заказ, пожалуйста, запомните номер вашего заказа:<br />
<script type="text/javascript">imCShowOrderNo();imCShowPayButton();</script>
С наилучшими пожеланиями, Группа продаж.
</div>
