...
<html>
<head>
   <title>Step 2 - Выбор способа доставки и оплаты</title>
	...
	<!--[if lt IE 7]><link rel="stylesheet" type="/static/text/css" href="/static/res/iebehavior.css" media="screen" /><![endif]-->
...
<div id="imSite">
    ...
    <div id="imBody">
        ...
        <a name="imGoToCont"></a>
        <div id="imContent">
            <h2>Step 2 - Выбор способа доставки и оплаты</h2>
            <div id="imCartText">Таблица содержит перечень всех продуктов в корзине и общую стоимость вашего заказа.
                <form name="frmShipment" class="imShipment" action="javascript:imCCheckout()">
                    <fieldset>
                        <script type="text/javascript">imCGetCart(false);</script>
                        Выберите желаемый способ доставки и оплаты, затем для перехода нажмите кнопку 'Далее'.<br /><br />
