...
<html><head>
	<title>Step 4 - Подача заявки</title>
...
<param name="quality" value="high" />
<param name="wmode" value="opaque" />
<param name="flashvars" value="txt=Магазин компьютеров" /></object>
<!--> <![endif]-->
	</object>
...
<a name="imGoToCont"></a>
	<div id="imContent">
<h2>Step 4 - Подача заявки</h2>
<div id="imCartText">Пожалуйста, проверьте правильность всех данных и выберите подтверждение вашего заказа.
...
<input class="imCartButton" type="button" value="Назад к корзине" onclick="imOpenLocation('imcart')" />
<input class="imCartButton" type="button" value="Редактировать данные" onclick="imOpenLocation('imform')" />
<input class="imCartButton" type="submit" value="Далее" />
</div>
