...
<div id="imCartText">Пожалуйста, заполните следующую форму.<br />Заполняйте все необходимые поля.<br />Для перехода нажмите кнопку 'Далее'.
...
<input class="imCartButton" type="button" value="Перейти к корзине" onclick="imOpenLocation('imcart')" />
