...
<html>
<head>
    <title>Step 3 - Данные клиента</title>

    <!-- Contents -->
    <meta http-equiv="Content-Type" content="text/html; charset=windows-1251"/>
    <meta http-equiv="Content-Language" content="ru"/>
    <meta http-equiv="last-modified" content="16.09.2014 19:43:04"/>
...
<div id="imHeader">
    <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000"
            codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,0,0" width="992"
            height="147">
        ...
        <ul>
            ...
            <li><a class="imMnItm_3"><span class="imHidden">Мобильные устройства</span></a>
                <ul>
                    ...
                    <li><a href="gps-навигаторы_радар-детекторы.html" title="">GPS-навигаторы, радар-детекторы</a></li>
                </ul>
            </li>
            ...
            <li><a class="imMnItm_5"><span class="imHidden">Периферия</span></a>
                <ul>
                    <li><a href="мониторы_жидкокристалические.html" title="">Мониторы жидкокристалические</a></li>
...
<div id="imContent">
    <h2>Step 3 - Данные клиента</h2>

    <div id="imCartText">Пожалуйста, заполните следующую форму.<br/>Заполняйте все необходимые поля.<br/>Для перехода
        нажмите кнопку 'Далее'.
        <form class="imUserData" name="imFormTableDat" method="post" onsubmit="return ChkFrm(this)"
              action="javascript:imCSetUserData();">
            <fieldset>
                <div>
...
<input class="imField imInput_1" type="text" name="imTxtDat" id="Itm16"/>
                ...
                <div>
                    <label for="Itm_Note">
                        <span class="imLabel">Заметка:<br class="imHidden"/></span>
<span class="imLabel_Cont">
<textarea class="imField imInput_0" name="imTxtDat" id="Itm_Note" rows="3" cols="15"></textarea>
                ...
                <div class="imAlign_center">
                    <input class="imCartButton" type="button" value="Перейти к корзине"
                           onclick="imOpenLocation('imcart')"/>
