    ...
    <div class="dropdown-menu">
        <form class="form-horizontal loginFrm">
            <div class="control-group">
                <a href="<c:url value="/employeeTable"/>"><i class="c"></i>Сотрудники</a>
            </div>
            <div class="control-group">
                <a href="<c:url value="/clientTable"/>"><i class="c"></i>Клиенты</a>
            </div>
            <div class="control-group">
                <a href="<c:url value="/bookingTable"/>"><i class="c"></i>Заказы</a>
            </div>
            <div class="control-group">
                <a href="<c:url value="/productTable"/>"><i class="c"></i>Товары</a>
            </div>
        </form>
    </div>
