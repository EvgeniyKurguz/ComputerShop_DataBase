...
<head>
    ...
    <meta http-equiv="last-modified" content="25.08.2014 00:28:41"/>
                            ...
                            <div>
                                <div class="imCartBrd">
                                    <div class="imCartItem">
                                        <div class="imCRImg"><a
                                                href="javascript:imShowBox('/static/cart/fal9_wi5_p0049_00.jpg',371,500,'','IMG','t');"><img
                                                src="/static/cart/pal9_wi5_p0049_00.jpg" alt="Laptop/124533" width="83"
                                                height="61" style="margin-top:40px; border: none;"/></a></div>
                                        <div class="imCRDescF"><strong>Laptop/124533</strong><br/>Самый крутой ноутбук
                                        </div>
                                        <div class="imCRLast">520.00 $</div>
                                        <div class="imCRLast" style="text-align: right"><input id="imQtyal91"
                                                                                               type="text" value="1"
                                                                                               size="4" maxlength="4"/>
                                            <img src="/static/res/imcartadd.gif" alt="Добавить в корзину"
                                                 style="vertical-align: bottom; cursor: pointer"
                                                 onclick="imCAddProdLink('im31309','al9','wi5','',imGetLayer('imQtyal91').value)"/>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div id="imObj9_01">
                            <div>
                                <div class="imCartBrd">
                                    <div class="imCartItem">
                                        <div class="imCRImg"><a
                                                href="javascript:imShowBox('/static/cart/fyl2_ve8_p0049_01.jpg',303,500,'','IMG','t');"><img
                                                src="/static/cart/pyl2_ve8_p0049_01.jpg" alt="Ноутбук/125" width="83"
                                                height="50" style="margin-top:46px; border: none;"/></a></div>
                                        <div class="imCRDescF"><strong>Ноутбук/125</strong><br/></div>
                                        <div class="imCRLast">698.00 $</div>
                                        <div class="imCRLast" style="text-align: right"><input id="imQtyyl21"
                                                                                               type="text" value="1"
                                                                                               size="4" maxlength="4"/>
                                            <img src="/static/res/imcartadd.gif" alt="Добавить в корзину"
                                                 style="vertical-align: bottom; cursor: pointer"
                                                 onclick="imCAddProdLink('im31309','yl2','ve8','',imGetLayer('imQtyyl21').value)"/>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <div style="position: absolute; left: 810px; top: 21px; width: 152px; height: 21px; ">
                <form id="imSearch_11" action="imsearch.php" method="get" style="white-space: nowrap">
                    <fieldset><input type="text" name="search" value=""
                                     style="width: 75px; font: 11px Tahoma; color: #000000; background: #FFFFFF url('res/imsearch.gif') no-repeat 3px; padding: 3px 3px 3px 21px; border: 1px solid #000000; vertical-align: middle"/> <span
